    ...
    <div class="row">
      ...
      <div class="col-md-4">
       <div class="infoSection">
        ...
        <ul>
          <li>Sunday School / Worship</li>
          <li>9:30 AM / 10:30 AM</li>
          <li><button class="btn">Add to Calendar</button></li>
        </ul>
        <hr>
        <h4>Find Us</h4>
        <ul>
          <li>125 E. Green St.</li>
          <li>Versailles, KY 40383</li>
          <li><button class="btn">Get Directions</button></li>
        </ul>
        <hr>
